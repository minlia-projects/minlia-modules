...
public class RoleEndpoint {
    ...
    @AuditLog(value = "create role", type = OperationTypeEnum.CREATE)
    ...
    @AuditLog(value = "update role", type = OperationTypeEnum.MODIFY)
    ...
    @AuditLog(value = "delete role by code", type = OperationTypeEnum.DELETE)
    ...
    @AuditLog(value = "grant permissions to role", type = OperationTypeEnum.MODIFY)
    ...
    @AuditLog(value = "query role by id", type = OperationTypeEnum.INFO)
    ...
    @AuditLog(value = "query role by code", type = OperationTypeEnum.INFO)
    @PreAuthorize(value = "hasAnyAuthority('" + RebeccaSecurityConstant.ROLE_SEARCH + "')")
    ...
    @AuditLog(value = "query role by guid", type = OperationTypeEnum.INFO)
    @PreAuthorize(value = "hasAnyAuthority('" + RebeccaSecurityConstant.ROLE_SEARCH + "')")
    ...
    @AuditLog(value = "query roles as paginated result", type = OperationTypeEnum.INFO)
    @PreAuthorize(value = "hasAnyAuthority('" + RebeccaSecurityConstant.ROLE_SEARCH + "')")
