...
public class RiskDroolsConfigEndpoint {
    ...
    @AuditLog(value = "save fraud drools config", type = AuditOperationTypeEnum.CREATE)
    ...
    @AuditLog(value = "reset drools config", type = AuditOperationTypeEnum.UPDATE)
    ...
    @AuditLog(value = "query fraud drools config by id", type = AuditOperationTypeEnum.SELECT)
    ...
    @AuditLog(value = "query fraud drools config as list", type = AuditOperationTypeEnum.SELECT)
    @PreAuthorize(value = "hasAnyAuthority('" + RiskSecurityConstants.DROOLS_CONFIG_SEARCH + "')")
