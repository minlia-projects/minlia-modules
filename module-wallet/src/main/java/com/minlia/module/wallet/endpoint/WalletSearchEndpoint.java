...
//import com.minlia.module.wallet.v1.body.WalletQueryRequestBody;
...
//	public StatefulBody list(@RequestBody ApiSearchRequestBody<WalletQueryRequestBody> body) {
//		List<Wallet> wallets = walletRepository.findAll(spec.buildSpecification(body));
...
//	public StatefulBody paginated(@PageableDefault Pageable pageable, @RequestBody ApiSearchRequestBody<WalletQueryRequestBody> body) {
//		Page page = walletRepository.findAll(spec.buildSpecification(body), pageable);
