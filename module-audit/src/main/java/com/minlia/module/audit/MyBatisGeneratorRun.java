package com.minlia.module.audit;
...
public class MyBatisGeneratorRun {
     ...
     * 项目名
     */
    private final String projectName = "module-audit";
     ...
     * 指定包名
     */
    private final String packageName = "com.minlia.module.audit";
...
//    private final String[] tableNames = new String[]{"hsjs_brand, hsjs_product_category"};
    private final String[] tableNames = new String[]{"mdl_audit_log"};
