package com.minlia.cloud.data.jpa.support.tenant.domain;
...
//@Table(name = PersistenceConstants.MODULE_TABLE_PREFIX + "Role"
// ,
// uniqueConstraints={@UniqueConstraint(columnNames={ })}
//)
// A JPA annotation to define how to generate sequence
@SequenceGenerator(name = PersistenceConstants.SEQUENCE_GENERATOR_NAME, sequenceName = PersistenceConstants.SEQUENCE_PREFIX + "User")
