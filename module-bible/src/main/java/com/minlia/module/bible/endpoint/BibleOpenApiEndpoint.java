...
//import com.minlia.module.bible.ro.entity.BibleItem;
//import com.minlia.module.bible.ro.ro.BibleItemQRO;
...
//    List<BibleItem> found = bibleItemService.queryList(BibleItemQRO.builder().code(code).build());
...
//  public Response findAll(@PageableDefault Pageable pageable, @RequestBody BibleItemQRO ro) {
//    return Response.success(bibleItemService.queryPage(ro, pageable));
//  }
//
//}
