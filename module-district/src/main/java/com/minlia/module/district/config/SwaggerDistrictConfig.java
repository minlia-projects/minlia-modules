package com.minlia.module.district.config;
 ...
 */
@Component
public class SwaggerDistrictConfig extends SwaggerConfiguration {

    public SwaggerDistrictConfig(SwaggerProperties swaggerProperties) {
        super(swaggerProperties);
    }

    @Bean
    public Docket webApiDistrict() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .paths(PathSelectors.ant("/api/**/district/**"))
                .build()
