...
public interface NestedSetRetriever<ID extends Serializable, ENTITY extends NestedSet<ID>> {
    ...
    Tree<ID, ENTITY> getTree(ENTITY entity);

    List<ENTITY> getParents(ENTITY entity);

    Optional<NestedSetDetail<ID>> getNestedSetDetail(ID nestedSetDetailIds);
