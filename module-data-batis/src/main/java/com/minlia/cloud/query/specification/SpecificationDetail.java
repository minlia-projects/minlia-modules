package com.minlia.cloud.query.specification;
...
public class SpecificationDetail<T> implements Serializable {
    ...
    public List<QueryCondition> getAndQueryConditions() {
        if (persistentClass != null && PreconditionsHelper.isNotEmpty(andQueryConditions)) {
    ...
    public List<QueryCondition> getOrQueryConditions() {
        if (persistentClass != null && PreconditionsHelper.isNotEmpty(orQueryConditions)) {
