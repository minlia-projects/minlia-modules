...
public class MyBatisGeneratorRun {
     ...
     * 项目名
     */
    private final String projectName = "module-lov";
     ...
     * 指定包名
     */
    private final String packageName = "com.minlia.module.lov";
...
//    private final String[] tableNames = new String[]{"hsjs_brand, hsjs_product_category"};
    private final String[] tableNames = new String[]{"mdl_lov", "mdl_lov_value"};
