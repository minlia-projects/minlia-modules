...
public class MyBatisGeneratorRun {
     ...
     * 项目名
     */
    private final String projectName = "module-captcha";
     ...
     * 指定包名
     */
    private final String packageName = "com.minlia.module.captcha";
     ...
     * 指定生成的表名
     */
    private final String[] tableNames = new String[]{"sys_captcha"};
