...
import com.minlia.cloud.data.jpa.support.auditing.AuditorHolder;
import com.minlia.cloud.data.jpa.support.entity.AbstractAuditingEntity;
...
public class AbstractAuditingEntityListener {
    ...
    public void AbstractAuditingEntityPrePersist(AbstractAuditingEntity entity) {
        ...
        entity.setCreatedBy(AuditorHolder.getAuditor());
        entity.setLastModifiedBy(AuditorHolder.getAuditor());
    }
