//package com.minlia.fungame.activationcode;
//
...
//     * 数据库连结信息
//     */
//    private final String dbUrl = "jdbc:mysql://127.0.0.1:3306/fungame_dev?useUnicode=true&characterEncoding=UTF8&serverTimezone=Asia/Shanghai&useSSL=false&autoReconnect=true&autoReconnectForPools=true&allowMultiQueries=true";
...
//     * 项目名
//     */
//    private final String projectName = "module-article";
//
//    /**
...
//     * 指定包名
//     */
//    private final String packageName = "com.minlia.module.article";
//
//    /**
//     * controller基础类
//     */
...
//     * entity基础类
//     */
////    private final String superEntityClass = packageName + ".BaseEntity";
////    private final String superEntityClass = "com.minlia.module.data.entity.AbstractEntity";
...
//
//    //指定生成的表名
////    private final String[] tableNames = new String[]{"hsjs_brand, hsjs_product_category"};
//    private final String[] tableNames = new String[]{"sys_article"};
//
//    @Test
