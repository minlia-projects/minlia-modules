...
public interface UserHistoryMapper {
    ...
    Long countByUpdateTypeAndGuidAndLastModifiedDateAfter(@Param("updateType")UserUpdateTypeEcnum updateType,@Param("guid")String guid,@Param("minLastModifiedDate")Date minLastModifiedDate);
