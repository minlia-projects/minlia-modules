...
public class WalletSecurityConstant {
    ...
    public final static String WITHDRAW_APPROVAL_CODE = MODULE_WITHDRAW_CODE + SecurityConstant.OPERATION_APPROVAL_CODE;
    public final static String WITHDRAW_APPROVAL_DESC = MODULE_WITHDRAW_DESC + SecurityConstant.OPERATION_APPROVAL_DESC_CN;
