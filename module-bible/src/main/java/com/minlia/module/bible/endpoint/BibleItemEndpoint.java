...
public class BibleItemEndpoint {
    ...
    @AuditLog(value = "create system bible item")
    ...
    @AuditLog(value = "update system bible item")
    ...
    @AuditLog(value = "delete system bible item by id")
    ...
    @AuditLog(value = "query system bible item by id")
    ...
    @AuditLog(value = "query system bible item by code")
    @PreAuthorize(value = "hasAnyAuthority('" + BibleConstants.SEARCH + "')")
    ...
    @AuditLog(value = "query system bible item by parent code")
    @PreAuthorize(value = "hasAnyAuthority('" + BibleConstants.SEARCH + "')")
    ...
    @AuditLog(value = "query system bible item by query request body as list")
    @PreAuthorize(value = "hasAnyAuthority('" + BibleConstants.SEARCH + "')")
    ...
    @AuditLog(value = "query system bible item by query request body as paginated result")
    @PreAuthorize(value = "hasAnyAuthority('" + BibleConstants.SEARCH + "')")
