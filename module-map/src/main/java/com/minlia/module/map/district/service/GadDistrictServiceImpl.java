...
import com.minlia.module.map.district.constants.GadDistrictApiCode;
import com.minlia.module.map.district.constants.GadConstants;
...
import com.minlia.module.map.district.mapper.GadDistrictMapper;
...
public class GadDistrictServiceImpl implements GadDistrictService {
    ...
    public GadDistrict queryIdAndNotNull(Long id) {
        ...
        ApiPreconditions.is(null == district, GadDistrictApiCode.NOT_EXISTS,"区域不存在");
        return district;
    }
