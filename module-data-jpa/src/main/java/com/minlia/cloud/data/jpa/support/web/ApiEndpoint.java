 ...
 *
 * @param <T> Your resource Domain to manage, maybe an entity or DTO class
 */
public interface ApiEndpoint<T> {
    ...
    StatefulBody create(@Valid @RequestBody T resource);
    ...
    StatefulBody update(@PathVariable Long id, @Valid @RequestBody T resource);
