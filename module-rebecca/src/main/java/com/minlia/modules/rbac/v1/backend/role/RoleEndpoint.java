...
public class RoleEndpoint {
  ...
  @ApiOperation(value = "创建角色", notes = "创建角色", httpMethod = "POST", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @ApiOperation(value = "更新角色", notes = "更新角色", httpMethod = "PUT", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @ApiOperation(value = "获取一个指定ID的角色", notes = "获取一个指定ID的角色", httpMethod = "GET", produces = MediaType.APPLICATION_JSON_VALUE)
