package com.minlia.module.advertisement.config;
 ...
 */
@Component
public class SysAdvertisementSwaggerConfig extends SwaggerConfiguration {

    public SysAdvertisementSwaggerConfig(SwaggerProperties swaggerProperties) {
        super(swaggerProperties);
    }

    @Bean
    public Docket webApiAdvertisement() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .paths(PathSelectors.ant("/api/**/ad/**"))
                .build()
