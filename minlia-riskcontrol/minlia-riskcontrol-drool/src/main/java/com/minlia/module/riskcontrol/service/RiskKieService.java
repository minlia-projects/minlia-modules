...
//    }
    ...
    private static void setGlobal() {
        statelessKieSession.setGlobal("riskListService", ContextHolder.getContext().getBean(RiskListService.class));
        statelessKieSession.setGlobal("riskRecordService", ContextHolder.getContext().getBean(RiskRecordService.class));
        statelessKieSession.setGlobal("riskBlackIpService", ContextHolder.getContext().getBean(RiskBlackIpService.class));
        statelessKieSession.setGlobal("riskDimensionService", ContextHolder.getContext().getBean(RiskDimensionService.class));
