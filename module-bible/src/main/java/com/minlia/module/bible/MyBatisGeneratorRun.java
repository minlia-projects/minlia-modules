...
public class MyBatisGeneratorRun {
     ...
     * 项目名
     */
    private final String projectName = "module-bible";
     ...
     * 指定包名
     */
    private final String packageName = "com.minlia.module.bible";
...
//    private final String superEntityClass = "com.minlia.module.data.entity.AbstractEntity";
    ...
    //指定生成的表名
    private final String[] tableNames = new String[]{"sys_bible"};
