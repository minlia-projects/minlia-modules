package com.minlia.module.article.config;
 ...
 */
@Component
public class SysArticleSwaggerConfig extends SwaggerConfiguration {

    public SysArticleSwaggerConfig(SwaggerProperties swaggerProperties) {
