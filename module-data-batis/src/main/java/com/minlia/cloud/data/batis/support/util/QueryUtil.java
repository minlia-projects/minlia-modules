package com.minlia.cloud.data.batis.support.util;
...
public class QueryUtil {
     ...
     * @return
     */
    public static List<QueryCondition> convertObjectToQueryCondition(Object entity, Map<String, QueryOperator> operateMap) {
