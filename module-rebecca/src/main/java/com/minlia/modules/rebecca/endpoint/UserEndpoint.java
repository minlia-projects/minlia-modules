...
public class UserEndpoint {
    ...
    @AuditLog(value = "create user", type = OperationTypeEnum.CREATE)
    ...
    @AuditLog(value = "update user", type = OperationTypeEnum.MODIFY)
    ...
    @AuditLog(value = "lock user by guid", type = OperationTypeEnum.MODIFY)
    @PreAuthorize(value = "hasAnyAuthority('" + RebeccaSecurityConstant.USER_UPDATE + "')")
    ...
    @AuditLog(value = "disable user by guid", type = OperationTypeEnum.MODIFY)
    @PreAuthorize(value = "hasAnyAuthority('" + RebeccaSecurityConstant.USER_UPDATE + "')")
    ...
    @AuditLog(value = "grant roles to user", type = OperationTypeEnum.MODIFY)
    ...
    @AuditLog(value = "get my details", type = OperationTypeEnum.INFO)
    ...
    @AuditLog(value = "query a user", type = OperationTypeEnum.INFO)
    @PreAuthorize(value = "hasAnyAuthority('" + RebeccaSecurityConstant.USER_SEARCH + "')")
    ...
    @AuditLog(value = "query user as list", type = OperationTypeEnum.INFO)
    @PreAuthorize(value = "hasAnyAuthority('" + RebeccaSecurityConstant.USER_SEARCH + "')")
    ...
    @AuditLog(value = "query user as paginated result", type = OperationTypeEnum.INFO)
    @PreAuthorize(value = "hasAnyAuthority('" + RebeccaSecurityConstant.USER_SEARCH + "')")
