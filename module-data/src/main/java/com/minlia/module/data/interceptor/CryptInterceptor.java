...
//                    field.set(plainObject, stringEncrypt(((Enum) plain).name(), cryptField));
                    field.set(plainObject, Enum.valueOf(cryptField.enumClass(), stringEncrypt(((Enum) plain).name(), cryptField)));
                    continue;
                }
    ...
    private void beanDecrypt(Object cipherObject) throws IllegalAccessException {
        ...
        for (Field field : objFields) {
            ...
            if (cryptField != null) {
                ...
                if (field.getType().isEnum()) {
                    field.set(cipherObject, Enum.valueOf(cryptField.enumClass(), stringDecrypt((String) cipher, cryptField)));
                    continue;
                }
                if (field.getType().equals(List.class)) {
