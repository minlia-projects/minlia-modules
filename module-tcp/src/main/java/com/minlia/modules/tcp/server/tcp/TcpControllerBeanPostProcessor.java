...
public class TcpControllerBeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if (map.containsKey(beanName)) {
            List<Method> receiveMethods = new FastList(Method.class);
            List<Method> connectMethods = new FastList(Method.class);
            List<Method> disconnectMethods = new FastList(Method.class);
