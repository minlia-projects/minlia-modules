...
public class UserEndpoint {
    ...
    public StatefulBody search(@RequestParam int pageNum, @RequestParam int pageSize, @RequestBody UserQueryRequestBody body) {
        RowBounds rowBounds2 = new RowBounds(1,10);
        PageRowBounds rowBounds1 = new PageRowBounds(1,10);
