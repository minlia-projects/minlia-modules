...
public class MyBatisGeneratorRun {
     ...
     * 项目名
     */
    private final String projectName = "module-richtext";
     ...
     * 指定包名
     */
    private final String packageName = "com.minlia.module.richtext";
     ...
     * 指定生成的表名
     */
    private final String[] tableNames = new String[]{"sys_richtext"};

    /**
     * 表前缀
     */
    private final String TABLE_PREFIX = "sys_";
