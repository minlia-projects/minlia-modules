...
//	@ApiOperation(value = "收藏", remark = "收藏", httpMethod = "POST", produces = MediaType.APPLICATION_JSON_VALUE)
...
//
//	@PreAuthorize(value = "hasAnyAuthority('" + ArticleConstants.READ + "')")
//	@ApiOperation(value = " 是否收藏", remark = "是否收藏", httpMethod = "GET", produces = MediaType.APPLICATION_JSON_VALUE)
...
//
//	@PreAuthorize(value = "hasAnyAuthority('" + ArticleConstants.READ + "')")
//	@ApiOperation(value = "计数查询", remark = "计数查询", httpMethod = "POST", produces = MediaType.APPLICATION_JSON_VALUE)
...
//
//	@PreAuthorize(value = "hasAnyAuthority('" + ArticleConstants.READ + "')")
//	@ApiOperation(value = "集合查询", remark = "编号查询", httpMethod = "POST", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
...
//
//	@PreAuthorize(value = "hasAnyAuthority('" + ArticleConstants.READ + "')")
//	@ApiOperation(value = "分页查询", remark = "编号查询", httpMethod = "POST", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
