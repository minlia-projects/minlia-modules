...
import com.minlia.cloud.utils.DateUtil;
import com.minlia.cloud.utils.Json;
...
public class GeneralEndpoint{
    ...
    protected static Logger logger = LoggerFactory.getLogger(GeneralEndpoint.class);
    ...
    public static final void writeStringHttpResponse(String str, HttpServletResponse response) {
        if (str == null)
            throw new ApiException("WRITE_STRING_RESPONSE_NULL");
        response.reset();
    ...
    public static final void writeJsonHttpResponse(Object object, HttpServletResponse response) {
        if (object == null)
            throw new ApiException("WRITE_JSON_RESPONSE_NULL");
        try {
            response.reset();
