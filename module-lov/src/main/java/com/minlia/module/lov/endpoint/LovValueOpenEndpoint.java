...
public class LovValueOpenEndpoint {
    ...
    @AuditLog(value = "query a lov value by id", type = OperationTypeEnum.INFO)
    ...
    @AuditLog(value = "query lov values by query request body as list", type = OperationTypeEnum.INFO)
    ...
    @AuditLog(value = "query lov values by query request body as paginated result", type = OperationTypeEnum.INFO)
