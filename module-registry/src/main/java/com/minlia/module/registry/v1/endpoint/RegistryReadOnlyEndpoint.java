...
import com.minlia.module.registry.v1.body.RegistryQueryRequestBody;
...
public class RegistryReadOnlyEndpoint implements
    ...
    public StatefulBody findAll(@RequestBody ApiQueryRequestBody<RegistryQueryRequestBody> body,
                                @PageableDefault Pageable pageable) {
        Page found = registryReadOnlyService.findAll(body,pageable);
    ...
    public SuccessResponseBody findAll(
            @RequestBody ApiQueryRequestBody<RegistryQueryRequestBody> body) {
        return SuccessResponseBody.builder().payload(registryReadOnlyService.findAll(body)).build();
    }
