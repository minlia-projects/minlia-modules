...
//import com.minlia.module.bible.v1.service.TodoService;
...
//        //菜单
//        initialAdminPermissions.put(TodoService.ENTITY_CREATE, SecurityConstants.CREATE_OPERATION_DESCRIPTION_CN + entityName);
//        initialAdminPermissions.put(TodoService.ENTITY_READ, SecurityConstants.READ_OPERATION_DESCRIPTION_CN + entityName);
//        initialAdminPermissions.put(TodoService.ENTITY_UPDATE, SecurityConstants.UPDATE_OPERATION_DESCRIPTION_CN + entityName);
//        initialAdminPermissions.put(TodoService.ENTITY_DELETE, SecurityConstants.DELETE_OPERATION_DESCRIPTION_CN + entityName);
//        initialAdminPermissions.put(TodoService.ENTITY_SEARCH, SecurityConstants.SEARCH_OPERATION_DESCRIPTION_CN + entityName);
//
//
