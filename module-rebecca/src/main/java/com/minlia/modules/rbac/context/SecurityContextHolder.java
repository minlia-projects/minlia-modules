...
//        EntityManagerFactory entityManager = ContextHolder.getContext().getBean(EntityManagerFactory.class);
...
//        QueryBase result = new JPAQuery(em).from(path).from(QUser.user).where(hasUsername).;
//
