...
public class GeoPoiServiceImpl implements GeoPoiService {
    ...
    //查询指定id的数据
    private static String query_detail_url = "http://api.map.baidu.com/geodata/v3/poi/detail";
     ...
     * @return
     */
    private Object post(String url, ApiRequestBody request, MultiValueMap<String, Object> keys, Class<?> responseClass){
