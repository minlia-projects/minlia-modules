...
public class ArticleCategoryEndpoint {
	...
	public Response create(@Valid @RequestBody ArticleCategoryCTO cto) {
	...
	public Response update(@Valid @RequestBody ArticleCategoryUTO uto) {
	...
	public Response id(@PathVariable Long id) {
		return Response.success(articleCategoryService.queryById(id));
	}
