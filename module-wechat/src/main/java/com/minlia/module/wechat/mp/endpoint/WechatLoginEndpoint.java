...
public class WechatLoginEndpoint {
    ...
    public Response loginByWxMpCode(@Valid @RequestBody LoginWechatRequestBody body) throws WxErrorException {
    ...
    public Response loginByWxMaCode(@Valid @RequestBody LoginWechatRequestBody body) {
