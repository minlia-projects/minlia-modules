...
public class SysWalletTransferServiceImpl extends ServiceImpl<SysWalletTransferMapper, SysWalletTransferEntity> implements SysWalletTransferService {
    ...
    public boolean create(WalletTransferRo transferRo) {
        ...
        sysWalletService.update(WalletUro.builder().uid(transferRo.getFrom()).type(WalletOperationTypeEnum.PAY).amount(transferRo.getAmount()).remark(transferRo.getRemark()).build());
        sysWalletService.update(WalletUro.builder().uid(transferRo.getTo()).type(WalletOperationTypeEnum.RECEIVABLES).amount(transferRo.getAmount()).remark(transferRo.getRemark()).build());
